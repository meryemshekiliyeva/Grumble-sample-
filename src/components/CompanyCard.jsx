...
const CompanyCard = ({ name, category, icon, bgColor }) => {
  return (
    <div className="group cursor-pointer">
      <div className="bg-card text-card-foreground rounded-xl border border-gray-200 shadow-lg transition-all duration-300 hover:-translate-y-2 hover:shadow-xl">
